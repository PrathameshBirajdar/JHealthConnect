...
public class AppointmentController {
    ...
    public String bookAppointment(@Valid @ModelAttribute("appointment") Appointment appointment,
        ...
        try {
            ...
            redirectAttributes.addFlashAttribute("error", "Error updating appointment status!");
        }
        return "redirect:/appointments/list";
    }}e){

    List<Doctor> doctors = doctorService
            .getAllDoctors();model.addAttribute("doctors",doctors);model.addAttribute("error","An error occurred while booking the appointment. Please try again.");return"Appointment";
    }}
